...
router
  .route('/')
  .post(auth('master'), validate(userValidation.createUser), userController.createUser)
...
router
  ...
  .patch(auth('basic'), validate(userValidation.updateUser), userController.updateUser)
